export const m = {
  ...
  InputDescriptionisrequired: 'Input Description is required',
  OutputDescriptionisrequired: 'Output Description is required',
  Uploadfailed: 'Upload failed',
  Sampleisrequired: 'Sample is required',
  Sampleinputandoutputisrequired: 'Sample input and output is required',
  Pleaseaddatleastonetag: 'Please add at least one tag',
  Spjcodeisrequired: 'SPJ code is required',
  SPJcodehasnotbeensuccessfullycompiled: 'SPJ code has not been successfully compiled',
  Pleasechooseatleastonelanguageforproblem: 'Please choose at least one language for the problem',
  Testcaseisnotuploadedyet: 'Testcase is not uploaded yet',
  Invalidtestcasescore: 'Invalid testcase score',
  Testcasescoremustbeaninteger: 'Testcase score must be an integer',
  Sample: 'Sample',
  Delete: 'Delete',
