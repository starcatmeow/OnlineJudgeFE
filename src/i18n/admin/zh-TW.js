export const m = {
  ...
  Tag: '標籤',
  New_Tag: '新增標籤',
  DisplayIDisrequired: '需要輸入顯示 ID',
  Titleisrequired: '需要輸入題目',
  InputDescriptionisrequired: '需要輸入輸入描述',
  OutputDescriptionisrequired: '需要輸入輸出描述',
  Uploadfailed: '上傳失敗',
  Sampleisrequired: '需要至少一組輸入輸出樣例',
  Sampleinputandoutputisrequired: '需要至少一組輸入輸出樣例',
  Pleaseaddatleastonetag: '請至少添加一個標籤',
  Spjcodeisrequired: '需要輸入SPJ代碼',
  SPJcodehasnotbeensuccessfullycompiled: 'SPJ代碼還沒有編譯完成',
  Pleasechooseatleastonelanguageforproblem: '請至少為題目選擇一種語言',
  Testcaseisnotuploadedyet: '還沒有上傳數據',
  Invalidtestcasescore: '測試點分數不合法',
  Testcasescoremustbeaninteger: '測試點分數必須是一個整數',
  Sample: '樣例',
  Delete: '刪除',
  CompileError: 'SPJ代碼編譯失敗',
  // ProblemList.vue
