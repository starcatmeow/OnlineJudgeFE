export const m = {
  ...
  Tag: '标签',
  New_Tag: '新增标签',
  DisplayIDisrequired: '需要输入显示 ID',
  Titleisrequired: '需要输入题目',
  InputDescriptionisrequired: '需要输入输入描述',
  OutputDescriptionisrequired: '需要输入输出描述',
  Uploadfailed: '上传失败',
  Sampleisrequired: '需要至少一组输入输出样例',
  Sampleinputandoutputisrequired: '需要至少一组输入输出样例',
  Pleaseaddatleastonetag: '请至少添加一个标签',
  Spjcodeisrequired: '需要输入SPJ代码',
  SPJcodehasnotbeensuccessfullycompiled: 'SPJ代码还没有编译完成',
  Pleasechooseatleastonelanguageforproblem: '请至少为题目选择一种语言',
  Testcaseisnotuploadedyet: '还没有上传数据',
  Invalidtestcasescore: '测试点分数不合法',
  Testcasescoremustbeaninteger: '测试点分数必须是一个整数',
  Sample: '样例',
  Delete: '删除',
  CompileError: 'SPJ代码编译失败',
  // ProblemList.vue
